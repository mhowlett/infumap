...
output = """// Copyright (C) 2022 Matt Howlett
// This file is part of Infumap.
//
// This program is free software: you can redistribute it and/or modify
// it under the terms of the GNU Affero General Public License as
...
for f in png_files:
    output += "#[get(\"/" + f + "\")] fn " + fn_name(f) + "() -> RawPngImage<&'static [u8]> { RawPngImage { image_data: include_bytes!(\"../../../web/dist/assets/" + f + "\") } }\n"

for f in ico_files:
    output += "#[get(\"/" + f + "\")] fn " + fn_name(f) + "() -> RawIcoImage<&'static [u8]> { RawIcoImage { image_data: include_bytes!(\"../../../web/dist/assets/" + f + "\") } }\n"
